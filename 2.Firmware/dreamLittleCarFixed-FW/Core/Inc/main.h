...
#define TRACK_OUT2_Pin GPIO_PIN_11
#define TRACK_OUT2_GPIO_Port GPIOB
#define TRACK_OUT3_Pin GPIO_PIN_12
#define TRACK_OUT3_GPIO_Port GPIOB
#define TRACK_OUT4_Pin GPIO_PIN_13
#define TRACK_OUT4_GPIO_Port GPIOB
#define TRACK_OUT5_Pin GPIO_PIN_14
#define TRACK_OUT5_GPIO_Port GPIOB
#define MOTOR1_CTRL1_Pin GPIO_PIN_15
#define MOTOR1_CTRL1_GPIO_Port GPIOB
#define MOTOR1_CTRL2_Pin GPIO_PIN_8
#define MOTOR1_CTRL2_GPIO_Port GPIOA
#define HC05_RXD_Pin GPIO_PIN_9
